...
public class GeneralExceptionHandler {
    ...
    public ResponseEntity<String> userNotFound(SomethingNotFoundException ex){ //passo come parametro del metodo l'eccezione che viene sollevata nel controller
